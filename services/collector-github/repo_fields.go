...
func gitRepoScalarStructure() map[string]fieldDescriptor {
	return map[string]fieldDescriptor{
		...
		"created_at":             {Type: "string", Length: 64},
		"updated_at":             {Type: "string", Length: 64},
...
func repoToScalarValues(repo *github.Repository) map[string]any {
	...
	out := map[string]any{
		...
		"created_at":             githubTimeRFC3339(repo.GetCreatedAt()),
		"updated_at":             githubTimeRFC3339(repo.GetUpdatedAt()),
